...
class GoogLeNet(Network):
    def setup(self):
        ...
        (self.feed('icp3_out0',
         ...
         .fc(2, relu=False, name='cls1_fc_pose_xyz'))
        ...
        (self.feed('icp6_out0',
         ...
         .fc(2, relu=False, name='cls2_fc_pose_xyz'))
        ...
        (self.feed('icp9_out0',
         ...
         .fc(2, relu=False, name='cls3_fc_pose_xyz'))

        #        (self.feed('cls3_fc_pose_xyz').to_array(cls3_fc_pose_xyz_val))

        (self.feed('cls3_fc1_pose')
         .fc(3, relu=False, name='cls3_fc_pose_wpqr'))


        #        (self.feed('cls3_fc_pose_wpqr').to_array(cls3_fc_pose_wpqr_val))
